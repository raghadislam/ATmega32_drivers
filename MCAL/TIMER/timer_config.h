...
#define TIMER0_MODE			TIMER_MODE_OVE
#define TIMER1_MODE			TIMER_MODE_CTC
...
#define TIMER0_PRESCALER		TIMER_NO_PRESCALER
#define TIMER1_PRESCALER		TIMER_NO_PRESCALER
...
#define TIMER0_CTC_ACTION		DISCONNECT_OC
...
#define TIMER1_FASTPWM_SELECTION	CLEAR_ON_COMP_SET_ON_TOP
...
* 3- OC_DISCONNECTED
* 4- TOGGLE_OC1A_ON_COMP_MATCH (timer1 only)*/

#define TIMER0_PWM_SELECTION		CLEAR_ON_UP_SET_ON_DOWN
#define TIMER1A_PWM_SELECTION		CLEAR_ON_UP_SET_ON_DOWN
#define TIMER1B_PWM_SELECTION		CLEAR_ON_UP_SET_ON_DOWN
...
#define TIMER0_STATE		ENABLED
#define TIMER1_STATE_A		ENABLED
#define TIMER1_STATE_B		ENABLED
#define TIMER2_STATE		ENABLED
#define ICU_STATE			DISABLED

#define ICU_TRIGGER			RISING_EDGE

#define TMR_TIMER1A_COMP_STATE	ENABLED
#define TMR_TIMER1B_COMP_STATE	ENABLED

#define SYSTEM_CLK		1000000ULL
