...
#define ICU_STATE					ENABLED

#define ICU_TRIGGER					RISING_EDGE

#define TIMER1_CTC_STATE_A		ENABLED
#define TIMER1_CTC_STATE_B		ENABLED

#define TIMER1_PWM_STATE_A		ENABLED
#define TIMER1_PWM_STATE_B		ENABLED

#define TIMER1_FASTPWM_STATE_A	ENABLED
#define TIMER1_FASTPWM_STATE_B	ENABLED
